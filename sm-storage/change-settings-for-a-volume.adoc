...
+
Se muestra el cuadro de diálogo Configuración de volumen. Las opciones de configuración del volumen seleccionado aparecen en este cuadro de diálogo.
...
Host
 a| 
Muestra la asignación del volumen. Es posible asignar un volumen a un host o un clúster de hosts para poder acceder a este para operaciones de I/O. Esta asignación otorga acceso a un host o un clúster de hosts a un volumen determinado o a una cantidad de volúmenes en una cabina de almacenamiento.
...
Información de carga de trabajo y aplicación
 a| 
Durante la creación del volumen, es posible generar cargas de trabajo específicas de la aplicación u otras cargas de trabajo. Si corresponde, se muestran el nombre de la carga de trabajo, el tipo de aplicación y el tipo de volumen del volumen seleccionado.
