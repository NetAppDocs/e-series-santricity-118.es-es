...
* *HTTPS* -- Le permite conectarse directamente al servidor de soporte técnico de destino utilizando HTTPS. Si desea habilitar AutoSupport OnDemand o Remote Diagnostics, el método de entrega de AutoSupport debe configurarse en HTTPS.
...
. Si tiene un firewall que bloquea la entrega de estos mensajes de ASUP, añada la siguiente URL a la lista blanca: `\https://support.netapp.com/put/AsupPut/`
...
+
Si la prueba de configuración presenta un error, revise la configuración y vuelva a ejecutar la prueba. Si la prueba continúa presentando errores, póngase en contacto con el soporte técnico.
