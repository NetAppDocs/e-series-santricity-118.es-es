...
---
= Importar la configuración de AutoSupport
:allow-uri-read: 
:experimental: 
:icons: font
:imagesdir: ../media/
...
La configuración importada incluye las funciones por separado (Basic AutoSupport, AutoSupport OnDemand y Remote Diagnostics), la ventana de mantenimiento, el método de entrega y la programación de mensajes.
