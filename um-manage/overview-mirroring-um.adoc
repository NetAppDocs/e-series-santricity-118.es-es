...
* link:create-asynchronous-mirrored-pair-um.html["Crear una pareja reflejada asíncrona"]
* link:create-synchronous-mirrored-pair-um.html["Crear una pareja reflejada síncrona"]
